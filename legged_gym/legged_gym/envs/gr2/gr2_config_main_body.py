...
class GR2MainBodyCfg(GR2BaseCfg):
    ...
    class asset(GR2BaseCfg.asset):
        file = "{LEGGED_GYM_ROOT_DIR}/resources/robots/GR2/urdf/GR2_main_body_raw.urdf"
...
class GR2MainBodyCfgPPO(GR2BaseCfgPPO, GR2MainBodyCfg):
